...
export default function ProjectCard({ project }: { project: Project }) {
    return (
        <Link
            ...
            className="mt-4 px-4 py-3  w-full rounded-lg shadow-md text-white cursor-pointer text-sm flex items-center justify-between  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent
