        ...
        <div className={`h-[500px] bg-white rounded-xl border border-gray-200 shadow-sm p-3 sm:p-4 overflow-y-auto`}>
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    <i className="fas fa-trophy text-[#5086ed] text-sm sm:text-base md:text-lg mr-1 sm:mr-2"></i>
                    <p className="text-black font-bold text-base sm:text-lg">Achievements & Certificate</p>
                </div>
                {owner && (
                    <button
                        className="flex items-center bg-[#5086ed] font-semibold py-1 sm:py-2 px-2 sm:px-4 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 group"
