...
const EndorserInput: React.FC<EndorserInputProps> = ({ onEndorserChange, existingEndorsers, title, label, placeholder }) => {
    ...
    return (
        <div className="mb-2 relative">
            ...
            <input
                ...
                placeholder={placeholder || "Eg. rduong1@paragoniu.edu.kh"}
                autoComplete="off"
            />
