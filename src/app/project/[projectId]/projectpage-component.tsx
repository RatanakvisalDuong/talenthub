            ...
            <div className={`max-w-8xl mx-auto sm:px-6 lg:px-8 py-20 flex justify-between ${updateProjectDialog || addCollaboratorDialog || addEndorserDialog || confirmRemoveCollaboratorDialog || confirmRemoveEndorserDialog ? "blur-md" : ""}`}>
                ...
                <div className="flex justify-between w-full">
                    <div className="h-[88vh] w-[73%]">
                        <div className="h-full w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent p-4 overflow-y-auto rounded-lg shadow-md">
                            <div className="w-full flex justify-between items-center mb-4">
                                <p className="text-xl font-bold text-white">{projectData.title}</p>
                                {projectData.google_id == userId ? (
                                    <div className="flex items-center justify-center">
                                        <div className="flex h-[30px] items-center justify-center mr-4">
                                            <p className="text-white font-bold text-md mr-2">
                                            ...
                                            <label className="relative inline-flex cursor-pointer">
                                                ...
                                                />
                                                <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer 
                            ...
                            <div className="w-full h-60  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-lg mx-auto flex justify-center items-center shadow-md">
                                <button onClick={prevSlide} className="text-white hover:bg-opacity-60 transition-all focus:outline-none hover:cursor-pointer">
                                    ...
                                    <div className="absolute bottom-3 left-0 right-0 z-10">
                                        <div className="flex justify-center gap-1">
                                            {slidePairs.map((_, index) => (
                                                <button key={index} onClick={() => goToSlide(index)} className={`h-2 transition-all ${currentSlide === index ? 'bg-[#5086ed] w-4 rounded-md' : ' bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-opacity-50 w-2 rounded-full'}`} />
                                            ))}
                                        </div>
                                    </div>
                                </div>
                                <button onClick={nextSlide} className="text-white hover:bg-opacity-60 transition-all focus:outline-none hover:cursor-pointer">
                                    <ArrowRightCircleIcon className="h-10 w-10" />
                                </button>
                            </div>

                            <div className="w-full mt-4 flex justify-end">
                                <Link className="h-10 w-max  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-md flex items-center justify-center text-white px-4 shadow-md hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group mr-4" href={projectData?.link || "#"} target="_blank" rel="noopener noreferrer">
                                    <LinkIcon className="h-5 w-5" /> Link
                                </Link>
                                {projectData.file && (
                                    <Link className="h-10 w-max  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-md flex items-center justify-center text-white px-4 shadow-md hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group" href={projectData.file}>
                            ...
                            <div className="w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent h-max mt-4 mb-4 rounded-lg shadow-md p-6">
                                <h1 className="text-white text-xl font-bold">Project Description</h1>
                                <div className="h-[2px] bg-gray-300 w-64 mt-2 mb-2"></div>
                                <div className="space-y-4">
                                    <p className="text-white mt-1 text-sm">{projectData?.description || "No description available."}</p>
                                </div>
                            </div>

                            <div className="w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent h-max mt-4 mb-4 rounded-lg shadow-md p-6">
                                <h1 className="text-white text-xl font-bold">Project Instruction</h1>
                                <div className="h-[2px] bg-gray-300 w-64 mt-2 mb-2"></div>
                                <div className="space-y-4">
                    ...
                    <div className="h-[88vh] w-[26%] overflow-y-auto">
                        <div className="h-max w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-lg shadow-md p-4 mb-4">
                            ...
                            <Link className=" bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white shadow-md rounded-lg px-4 py-3 flex items-center space-x-3 mt-3 hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group" href={`/portfolio/${projectData.google_id}`}>
                        ...
                        <div className="h-max w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-lg shadow-md p-4 mb-4">
                            <div className="flex items-center justify-between">
                                ...
                                {projectData.google_id == session?.googleId && <div className=" bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white shadow-md rounded-lg p-2 flex items-center space-x-2 hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group" onClick={() => { toggleAddEndorser() }}>
                            ...
                            {projectData.endorsers.filter((endorser: any) => endorser.endorsement_status === 2).length > 0 ? (
                                projectData.endorsers
                                    ...
                                    .map((endorser: any, index: number) => (
                                        <div key={index} className=" bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white shadow-md rounded-lg px-4 py-3 flex items-center space-x-3 mt-3 hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer group justify-between">
                        ...
                        <div className="h-max w-full  bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-lg shadow-md p-4 mb-4">
                            ...
                            {projectData?.programming_languages?.length > 0 ? (
                                projectData.programming_languages.map((language: any, index: number) => (
                                    <div key={index} className=" bg-indigo-500/20 border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white shadow-md rounded-lg px-4 py-3 flex items-center space-x-3 mt-3 hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300 ease-in-out group">
                                        <Code className="w-4 h-4  group-hover:text-white transition-colors duration-300" />
