    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-gray-50">
      <div className="mx-auto max-w-md rounded-lg bg-white p-8 shadow-md">
        <div className="flex items-center mb-4 text-red-600">
          ...
          <h1 className="text-2xl font-bold">Organization Email Required</h1>
        </div>
        <div className="mb-6 p-4 bg-red-50 border border-red-100 rounded-md text-gray-700">
          Please sign in with your organization email. Personal email domains
          like Gmail, Yahoo, etc. are not allowed.
        </div>
        <div className="mt-4 text-center">
          <button
            href="/"
            className="rounded bg-blue-500 px-6 py-2 text-white hover:bg-blue-600 inline-block"
